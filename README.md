...
* `lib/screens/`: Contains all full-screen widgets like `WelcomeScreen`, `YourNameScreen`, `QuestionScreen`, and `MainScreen`.
...
| :---: | :---: | :---: |
| <img src="https://github.com/oreskovs/AquaPulse/blob/main/screenshots/welcome_screen.png?raw=true" width="200"> | <img src="https://github.com/oreskovs/AquaPulse/blob/main/screenshots/Screenshot%203.png?raw=true" width="200"> | <img src="https://github.com/oreskovs/AquaPulse/blob/main/screenshots/Screenshot%204.png?raw=true" width="200"> |
